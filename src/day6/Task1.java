...
public class Task1 {
    public static void main(String[] args) {
        ...
        Car carTwo = new Car();
        Motorbike motorbike = new Motorbike(2019, "Yellow", "Yamaha");
        ...
        System.out.println(carOne.yearDifference(2021) + " - years old");
        System.out.println(motorbike.yearDifference(2021) + " - years old");
    }
